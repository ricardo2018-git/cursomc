...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
			...
			String nomeDecoded = URL.decodeParam(nome);			// Chama função p/ tirar espaço
			List<Integer> ids = URL.decodeIntList(categorias);	// chama função p/ converter uma string em uma lista de Integer
