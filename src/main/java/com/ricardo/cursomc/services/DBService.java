...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		// --- Inicio ---
			...
			// Manda salvar as Categorias, passa uma lista
			categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
			
			// Manda salvar os Produtos, passa uma lista
		...
		// --- Inicio ---
			Cliente cli1 = new Cliente(null, "Maria Silva", "rp_mira@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

			Cliente cli2 = new Cliente(null, "Ana Costa", "rp_mira2@hotmail.com", "90273677012", TipoCliente.PESSOAFISICA, pe.encode("123"));
			cli2.getTelefones().addAll(Arrays.asList("99876543", "89765430"));
		...
		// --- Inicio ---
			...
			// Associa pedido aos seis itens
			ped1.getItens().addAll(Arrays.asList(ip1, ip2));
			ped2.getItens().addAll(Arrays.asList(ip3));
			
			//Produto associa-se aos item de pedido
			p1.getItens().addAll(Arrays.asList(ip1));
			p2.getItens().addAll(Arrays.asList(ip3));
			p3.getItens().addAll(Arrays.asList(ip2));
			
			// salvando no BD os Itens de pedido
